...
/* harmony import */ var ngx_masonry__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-masonry */ "./node_modules/ngx-masonry/fesm5/ngx-masonry.js");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_posts_posts_component__WEBPACK_IMPORTED_MODULE_4__["PostsComponent"],
            ],
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"],
                ngx_masonry__WEBPACK_IMPORTED_MODULE_5__["NgxMasonryModule"],
...
var PostsComponent = /** @class */ (function () {
    function PostsComponent(postService, http) {
    ...
    PostsComponent.prototype.randomIntFromInterval = function (min, max) {
    ...
    PostsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_post_service__WEBPACK_IMPORTED_MODULE_1__["PostService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
    ], PostsComponent);
...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.getTitles = function (callback) {
        var _this = this;
        var titles = [];
        this.http.get(this.urlPosts)
            .subscribe(function (data) {
            while (titles.length < 100) {
                var id = _this.randomIntFromInterval(0, 99);
                titles.push(data[id].title);
            }
            callback(titles);
        });
    };
    PostService.prototype.randomIntFromInterval = function (min, max) {
        return Math.floor(Math.random() * (max - min + 1) + min);
    };
...
module.exports = __webpack_require__(/*! /home/lucas/Documents/angularjs/masonry/src/main.ts */"./src/main.ts");
